...
export const CreditCard = () => {
   ...
   return <div>
      ...
      <div>
         ...
         <div>
            <p style={{marginTop:'20px' , width:'400px'}}>Enter your credit card detail</p>
            ...
            <div className="credit-card-logo" >
               ...
               <img className="credit-card-img" src="https://d36g7qg6pk2cm7.cloudfront.net/assets/visa_mastercard-24e2ffa5d62a09351fa66b54c1cac94070b87ee181ec12ff35b7f67e573973a0.png"
                  alt="test" width="127px" height="21px" />
               <input style={{ marginLeft: "4%" }} className="form-check-input" type="radio" name="flexRadioDefault" />
               <img className="credit-card-img" src="https://d36g7qg6pk2cm7.cloudfront.net/assets/american_express-6d3a29aa70d346eea440f529b26c328a70cb3174956fbcedf3dad366d4100b9c.png"
                  alt="test" width="55px" height="25px"/>
               <input style={{ marginLeft: "4%" }} className="form-check-input" type="radio" name="flexRadioDefault" />
               <img className="credit-card-img" src="https://d36g7qg6pk2cm7.cloudfront.net/assets/diners_club-f9e57f98657b6d134bb600710e4c43c35f798acc621552e8d9cf168fb4a25988.png"
                  alt="test" width="67px" height="25px" />
                  <input style={{ marginLeft: "4%" }} className="form-check-input" type="radio" name="flexRadioDefault" />
                <img src="https://d36g7qg6pk2cm7.cloudfront.net/assets/rupay-0817613f9104b0be7203a0b12910dbeac272daa38187c9e52960324532e12ba9.png" alt="" width="55px" height="25px"/>
            </div>
            ...
            <div style={{width: '350px'}}>
               <button className="make-payment" onClick={handleSubmit} variant="contained" size="medium">
               Make Payment
               </button>
            </div>
